...
class RankedLogger(logging.LoggerAdapter):
    ...
    def __init__(
        ...
        Args:
            ...
            rank_zero_only: Whether to force all logs to only occur on the rank zero
    ...
    def log(self, level: int, msg: str, rank: int | None = None, *args, **kwargs) -> None:
        ...
        the log will only occur on that rank/process.

        Args:
            level: The level to log at. See `logging.__init__.py` for more information.
