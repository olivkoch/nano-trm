...
class MLPEncoder(nn.Module):
    ...
    def __init__(self, 
        ...
        self.layers = nn.ModuleList([
            MLPBlock(hidden_size, dropout=dropout)
...
class LEDModule(LightningModule):
    ...
    def __init__(self,
        ...
        if use_task_embedding:
            ...
            self.register_buffer(
                'task_embeddings',
                torch.randn(1000, task_embedding_size) * 0.02
            )
    ...
    def encode_examples(self, inputs: List[torch.Tensor], 
                       outputs: Optional[List[torch.Tensor]] = None) -> torch.Tensor:
        """
    ...
    def forward(self, x: torch.Tensor,
                ...
                train_outputs: Optional[List[torch.Tensor]] = None) -> torch.Tensor:
        """
        Forward pass.
